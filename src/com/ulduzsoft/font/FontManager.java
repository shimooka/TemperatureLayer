...
public class FontManager
{
	...
	static public HashMap< String, String > enumerateFonts()
    {
        ...
        for ( String fontdir : fontdirs )
        {
            ...
            for ( File file : files )
            {
                ...
                if ( file.getAbsolutePath() != null && fontname != null )
	...
	static public Map<String, String> sortedFonts() {
        Map<String, String> fonts = new LinkedHashMap< String, String >();
        
		List<Map.Entry> entries = new ArrayList<Map.Entry>(enumerateFonts().entrySet());
        ...
        for (Map.Entry entry : entries) {
            fonts.put((String)entry.getKey(), (String)entry.getValue());
        }
